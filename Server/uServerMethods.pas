...
begin
  ...
  if Assigned(JO) then begin
    Result := FPessoa.PUT_pessoa( idpessoa, JO.ToString, msgerro );
...
var msgerro: string;
begin
  Result := FPessoa.DELETE_pessoa( idpessoa, msgerro );
  GetInvocationMetadata().ResponseCode := 200;
//  GetInvocationMetadata().ResponseContent := Result.ToString;
end;
...
var msgerro: string;
begin
  Result := FPessoa.GET_pessoa( idpessoa, msgerro );
  GetInvocationMetadata().ResponseCode := 200;
//  GetInvocationMetadata().ResponseContent := Result.ToString;
end;
...
begin
  ...
  if Assigned(JO) then begin
    Result := FPessoa.POST_pessoa( JO.ToString, msgerro );
